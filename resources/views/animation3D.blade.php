...
<head>
    ...
    <script async="" src="gtag/js.js?id=G-X8ZB6W03N6"></script>
<script>
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-6">
                        <div class="case-study-featured-thumb text-start">
                            <img src="assets/media/project/10.gif" alt="travel">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="case-study-featured">
                            <div class="section-heading heading-left">
                                ...
                                <p>3D Animation is a definite way to grasp the audience’s concentration by communicating value, illustrating services and products, enhancing information maintenance, & educating and entertaining them.</p>
                                <p></p>
              ...
              <div class="container">
                 ...
                 <div class="portfolio-wrap">
                    <ul class="nav nav-tabs cust-nav-tabs justify-content-center border-0" id="myTab" role="tablist">
                       <li class="nav-item">
                          <a class="nav-link active cust-nav-link" id="b2b-tab" data-toggle="tab" href="#b2b" role="tab" aria-controls="b2b" aria-selected="true">3D Animation</a>
                       </li>
                     <!--  <li class="nav-item">
                       ...
                       <div class="tab-pane fade show active" id="b2b" role="tabpanel"
                         ...
                         <div class="row portfolio-responsive-slider">
                             <div class="col-lg-4 col-md-12">
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/1.mp4">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="video-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/1.mp4" ><i class="fas fa-play" muted></i></a>
                                            </div>
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/3.mp4" data-poster="images/webp/portfolio/3d-animation/2.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="video-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/3.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/4.mp4" data-poster="images/webp/portfolio/3d-animation/3.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="portfolio-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/4.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/2.mp4" data-poster="images/webp/portfolio/3d-animation/5.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="video-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/2.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/6.mp4" data-poster="images/webp/portfolio/3d-animation/6.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="portfolio-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/6.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/7.mp4" data-poster="images/webp/portfolio/3d-animation/7.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="portfolio-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/7.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
                                ...
                                <div class="portfolio-box" data-video="https://www.citrusanimations.com/portfolio-videos/3d-animation/10.mp4" data-poster="images/webp/portfolio/3d-animation/8.webp">
                                   ...
                                   <div class="video-hover-box-wrap">
                                      ...
                                      <div class="video-hover-text-wrap">
                                         <div class="video-icon">
                                            <div class="video-play-icon">
                                               <a data-fancybox="video-2d-animation" href="https://www.citrusanimations.com/portfolio-videos/3d-animation/10.mp4"><i class="fas fa-play" muted></i></a>
                                            </div>
                                            {{-- <div class="video-like-icon">
                                               <a href="#"><i class="far fa-thumbs-up"></i></a>
                                            </div> --}}
