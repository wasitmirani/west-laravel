...
<head>
    ...
    <title>WestCoast Animations | Privacy Policy</title>
                ...
                <div class="container">
                    <div class="header-navbar">
                        <div class="header-logo">
                            <a href="{{route('index')}}"><img class="light-version-logo" src="assets/media/logo.gif" alt="logo"></a>
                            <a href="{{route('index')}}"><img class="dark-version-logo" src="assets/media/logo-3.gif" alt="logo"></a>
                            <a href="{{route('index')}}"><img class="sticky-logo" src="assets/media/logo-2.gif" alt="logo"></a>
                        </div>
                                ...
                                <div class="d-block d-lg-none">
                                    <div class="mobile-nav-header">
                                        <div class="mobile-nav-logo">
                                            <a href="{{route('index')}}">
                                                <img class="light-mode" src="assets/media/logo-2.gif" alt="Site Logo">
                                                <img class="dark-mode" src="assets/media/logo-3.gif" alt="Site Logo">
                                            </a>
                                        </div>
                                ...
                                <ul class="mainmenu">
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="axil-submenu">
                                            <li><a href="{{route('index')}}">Digital Agency</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="privacy-policy-content">
                            ...
                            <ul>
                                <li>• WestCoast Animations Inc’s refund policy will be nil if;.</li>
                                <li>• You have chosen a special package. The primary design concept has been approved. You have demanded revisions</li>
                                <li>• The cancellation has been made due to reasons non-related to the company.</li>
                                <li>• The company has not been contacted for more than 2 weeks of project. Company’s policies, or policy, have been violated.</li>
                                <li>• Other company or designer has been approached for the same project. The creative brief is lacking in required information.</li>
                                <li>• A complete design change has been demanded. The claim has crossed the given ‘request for refund’ time span.</li>
                                ...
                                <li>Note: Citrus Animations Inc holds all rights to reject any project or cancel the contract whenever it deems necessary. After the refund, you will not have any rights to use the designs for any purpose; they will be the sole property of Citrus Animations Inc. The company will be the rightful owner of the designs</li>

                            </ul>
                            <h4>CLAIM YOUR Refunds</h4>
                            <p class="mb--20">We do our best to meet your requirements and our designers do their best to fulfill your expectations.</p>
                            <ul>
                                <li>We believe in providing best designs and each of our designs is well researched and well crafted..</li>

                            </ul>
                            <h4>100% SATISFACTION GUARANTEE
                            </h4>
                            <p>Our unlimited revisions policy is to make sure that you are 100% satisfied. We aim at exceeding your expectations and strive to accomplish it.
                            ...
                            <p>The complete order will be sent to the mentioned account on the date stated on Order Confirmation as well as a confirmation email will also be sent.
                            ...
                            <p class="mb--20">Westcoast Animations Inc keeps the records of finalized designs so that in case of any misplaced order, you will be provided the exact file.

                                .</p>

                            <p class="mb--20"> <h1>CUSTOMER SUPPORT</h1>
                            ...
                            <p class="mb--20">Citrus Animations Inc will not be responsible for any communication done via any other platform than “info@citrusanimations.com” or any numbers not provided by us or given on our official website. However Citrus Animations Inc is the subsidiary of . We hold full responsibility for any information held or shared through our parent company.p>
